    ...
    return GradientScaffold(
      ...
      body: Obx(() => Column(
            children: [
              ...
              // Wait for data to fully load (including friendship status), then fade in
              AnimatedOpacity(
                duration: const Duration(milliseconds: 400),
                opacity: logic.isDataLoaded.value ? 1.0 : 0.0,
                child: Padding(
                  ...
                  child: Text.rich(
                    TextSpan(
                      children: [
                        ...
                        // Only show remark if still friends (after data loaded)
                        if (logic.isFriendship &&
                            (logic.userInfo.value.remark?.isNotEmpty ?? false))
                          TextSpan(
                            text: ' (${logic.userInfo.value.remark})',
                          ),
                      ],
                    ),
                    style: TextStyle(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (logic.isFriendship && logic.showAudioAndVideoCall) ...[
            24.horizontalSpace,
            CustomButton(
